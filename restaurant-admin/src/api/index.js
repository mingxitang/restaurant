...
export const uploadDishImage = (file) => {
  ...
  return http.post('/dishes/upload-image', data)
}
...
export const transferTable = (sourceTableId, targetTableId) => http.put('/orders/transfer-table', { sourceTableId, targetTableId })
